...
Example: 
ngram.py 5 3 sotiw.txt cap.txt
This program generates random sentences based on an Ngram model.
Command line settings : ngram.py 5 3 sotiw.txt
The red mulberry is not particularly attractive in winter.The american elm is tall, graceful, slender sprayed, and drooping as if from languor.In a description of the deciduous trees of northeastern america by annie oakes huntington with an introduction by charles s.
...
def print_m_sentences(n, m, ngram, n1gram):
    ...
    while punctuation_found < m:
        ...
        if cur_n1gram in ngram.keys():
            ...
            # produce probibility and selects next word
    ...
    # Compiles sentences into output
    output = ""
